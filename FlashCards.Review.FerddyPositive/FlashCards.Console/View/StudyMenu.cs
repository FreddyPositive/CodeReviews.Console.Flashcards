...
internal class StudyMenu
{
    ...
    internal void StudySession()
    {
        ...
        Console.WriteLine();
        Console.WriteLine("Enter 1 to Start Study Session");
    ...
    private void SelectStack()
    {
        ...
        Console.WriteLine("Please Enter the Stack Id to View the Flash Cards, enter 0 to return to Previous menu");
        Console.WriteLine();
    ...
    private void ViewFlashCards(int StackId)
    {
        ...
        {
            flashCardTable.AddRow(flashCard.DisplayId, flashCard.Question);
        }
    ...
    private void AnswerFlashCard(List<FlashCardsDTO> FlashCards)
    {
        ...
        flashCardId = flashCardDataAccess.GetFlashCardIdEntity(flashCardId, StackId);
        ...
        if (flashCardId == 0)
        {
            ...
            if (FlashCardslist != "")//only track session if atleast one frash card is in the list
